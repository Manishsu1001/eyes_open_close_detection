...
[train1 m1] = process_data("C:\Users\pande\Desktop\cats-20220213T115851Z-001\African",64, 64, 3);
[train2 m2] = process_data("C:\Users\pande\Desktop\dogs-20220213T115853Z-001\Asian",64, 64, 3);
%Adding cross- validation dataset
[traincv1 k1] = process_data("C:\Users\pande\Desktop\cats-20220213T115851Z-001\AfricanCv",64, 64, 3);
[traincv2 k2] = process_data("C:\Users\pande\Desktop\dogs-20220213T115853Z-001\Asiancv",64, 64, 3);
[m n] = size(train1)
[u v] = size(train2)
y1 = ones(m1,1);
y2= zeros(m2,1);
